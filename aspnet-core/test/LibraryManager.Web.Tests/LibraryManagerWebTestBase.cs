...
{
    public abstract class LibraryManagerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibraryManagerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibraryManagerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibraryManagerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibraryManagerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibraryManagerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibraryManagerDbContext, Task<T>> func)
        {
            T result;
